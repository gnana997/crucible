...
![Status: v0.6.5](https://img.shields.io/badge/status-v0.6.5-orange)
...
- **Next (planned):** TLS termination at the ingress proxy and native cloud-registry auth.
