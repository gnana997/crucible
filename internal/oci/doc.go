...
// artifacts. It covers the D1 pipeline: acquire (anonymous registry
// pull or docker-save side-load), assemble (flatten layers with
...
//
// Boot-time consumption of these artifacts is D2: the daemon computes
