...
func (c *Client) ConfigureService(ctx context.Context, sandboxID string, spec agentwire.ServiceSpec) (agentwire.ServiceStatus, error) {
	resp, err := c.do(ctx, http.MethodPut, "/sandboxes/"+sandboxID+"/service", spec)
	if err != nil {
		return agentwire.ServiceStatus{}, err
	}
	return decodeInto[agentwire.ServiceStatus](resp)
}

// StartService launches the configured service (POST .../service/start).
// Idempotent: starting a running service is a no-op success.
func (c *Client) StartService(ctx context.Context, sandboxID string) (agentwire.ServiceStatus, error) {
...
func (c *Client) StopService(ctx context.Context, sandboxID string, graceSec int) (agentwire.ServiceStatus, error) {
	var body any
	if graceSec > 0 {
...
func (c *Client) RestartService(ctx context.Context, sandboxID string) (agentwire.ServiceStatus, error) {
...
func (c *Client) ServiceStatus(ctx context.Context, sandboxID string) (agentwire.ServiceStatus, error) {
...
func (c *Client) ServiceLogs(ctx context.Context, sandboxID string, fromSeq uint64, maxBytes int) (agentwire.ServiceLogsResponse, error) {
	...
	return decodeInto[agentwire.ServiceLogsResponse](resp)
}
