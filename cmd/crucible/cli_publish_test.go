...
func TestParsePublish(t *testing.T) {
	cases := []struct {
		...
		{spec: "[::1]:8080:80", wantIP: "::1", wantHostPort: 8080, wantGuestPort: 80, wantProto: "tcp"},
		{spec: "[fd00::2]:8080:80/tcp", wantIP: "fd00::2", wantHostPort: 8080, wantGuestPort: 80, wantProto: "tcp"},
		{spec: "[::1]:8080:80:extra", wantErr: true},
		{spec: "[::1]8080:80", wantErr: true},
		{spec: "[::1", wantErr: true},
		{spec: "::1:8080:80", wantErr: true},
